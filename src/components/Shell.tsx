      ...
      <header className="sticky top-0 z-30 border-b border-white/10 bg-ink/75 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
          <Link href="/" className="flex items-center gap-3">
            <span className="grid h-10 w-10 place-items-center rounded-2xl bg-volt text-sm font-black text-ink shadow-glow">KR</span>
            <span>
              <span className="block text-lg font-semibold tracking-tight">Footballkitrader</span>
              <span className="hidden text-xs text-steel sm:block">international football marketplace</span>
            </span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            <div className="hidden sm:block"><LocaleControls /></div>
        ...
        <div className="mx-auto block max-w-7xl px-4 pb-3 sm:hidden"><LocaleControls /></div>
      </header>
      {children}
      <footer className="border-t border-white/10 px-4 py-10 text-sm text-steel">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-2"><ShieldCheck size={18} className="text-mint" /> Seller trust, affiliate transparency and AI moderation built in.</div>
