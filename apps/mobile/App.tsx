...
import { products, sellers } from "../../src/data/mock";
  ...
  return (
    <SafeAreaView className="flex-1 bg-ink">
      <ScrollView className="px-5">
        <View className="py-8">
          <Text className="text-sm font-semibold uppercase tracking-widest text-volt">FootballKitRadar mobile</Text>
          ...
          return (
            <View key={product.id} className="mb-4 rounded-3xl border border-white/10 bg-white/5 p-5">
              ...
              <View className="mt-5 flex-row justify-between">
                <View>
                  <Text className="text-xs text-steel">Quality</Text>
                  <Text className="text-2xl font-black text-volt">{product.qualityScore}</Text>
                </View>
                <View>
                  <Text className="text-xs text-steel">From</Text>
                  <Text className="text-2xl font-black text-white">EUR {totalPrice(offer).toFixed(2)}</Text>
                </View>
              </View>
